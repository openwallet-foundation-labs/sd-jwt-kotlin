...
internal class AdvancedTest {
    ...
    internal fun simpleTest() {
        val testConfig = TestConfig(trustedIssuers, issuerSigner, issuer, verifier, nonce, holderSigner, "Simple Test")
    ...
    internal fun simpleStructuredTest() {
        val testConfig =
            TestConfig(trustedIssuers, issuerSigner, issuer, verifier, nonce, holderSigner, "Simple Structured Test")
        val claims = SimpleCredential(
            issuer,
            "6c5c0a49-b589-431d-bae7-219122a9ec2c",
            "John",
    ...
    internal fun complexTest() {
        val testConfig = TestConfig(trustedIssuers, issuerSigner, issuer, verifier, nonce, holderSigner, "Complex Test")
    ...
    internal fun complexRecursiveTest() {
        val testConfig = TestConfig(trustedIssuers, issuerSigner, issuer, verifier, nonce, holderSigner, "Recursive Complex Test")
